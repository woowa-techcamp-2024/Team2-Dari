...
class PurchasedMemberRepositoryTest {
    ...
    @Autowired
    private PurchasedMemberRedisRepository purchasedMemberRepository;
    ...
    class Describe_addPurchasedMember {
        ...
        void it_adds_new_purchased_member_and_returns_one() {
            ...
            assertThat(redisTemplate.opsForSet()
                    .isMember(purchasedMemberRepository.TICKETS_PREFIX + ticketId + ":"
                            + purchasedMemberRepository.PURCHASED_MEMBERS_PREFIX, String.valueOf(userId))).isTrue();
        }
    ...
    class Describe_removePurchasedMember {
        ...
        void it_removes_purchased_member() {
            ...
            assertThat(redisTemplate.opsForSet()
                    .isMember(purchasedMemberRepository.TICKETS_PREFIX + ticketId + ":"
                            + purchasedMemberRepository.PURCHASED_MEMBERS_PREFIX, String.valueOf(userId))).isFalse();
        }
    ...
    class Describe_isPurchasedMember {
        ...
        void zit_returns_true_for_purchased_member() {
            // Given
            Long ticketId = 1L;
            Long userId = 100L;
            purchasedMemberRepository.addPurchasedMember(ticketId, userId);
