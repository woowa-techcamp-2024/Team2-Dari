...
class CurrentlyPayingMemberRepositoryTest {
    ...
    @Autowired
    private CurrentlyPayingMemberRedisRepository repository;
    ...
    class Describe_addCurrentlyPayingMember {
        ...
        class Context_with_existing_paying_member {
            ...
            void it_does_not_change_set_size() {
                Long initialSize = redisTemplate.opsForSet().size(repository.TICKETS_PREFIX + TEST_TICKET_ID + ":"
                        + repository.CURRENTLY_PAYING_MEMBERS_PREFIX);
                repository.addCurrentlyPayingMember(TEST_TICKET_ID, TEST_USER_ID);
                Long finalSize = redisTemplate.opsForSet().size(repository.TICKETS_PREFIX + TEST_TICKET_ID + ":"
                        + repository.CURRENTLY_PAYING_MEMBERS_PREFIX);
